...
<h4><i>19 Oct 2020(AFTER 7 DAYS OF LAUNCH ON INTERNET):<ul><li> MYNOTES++ GAINED USERS FROM 4 COUNTRIES(3 CONTINENTS)<br>INCLUDING FRANCE(EUROPE),USA(AMERICA),INDIA(ASIA) AND CHINA(ASIA)</i></li></ul></h4><hr>
